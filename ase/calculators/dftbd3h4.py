...
class DftbD3H4(FileIOCalculator):
    """ A dftb+-D3H4 calculator with ase-FileIOCalculator nomenclature
    """
    ...
    def read_energy(self):
        ...
        try:
            ...
            self.results['energy'] = d3h4_energy+dftb_energy
        except:
    ...
    def read_forces(self):
        ...
        try:
            ...
            self.results['forces'] = dftb_forces+d3h4_forces
